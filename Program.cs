...
namespace COM3D2_DLC_Checker
{
    ...
    class Program
    {
        ...
        static void PRINT_HEADER()
        {
            ...
            CONSOLE_COLOR(ConsoleColor.Cyan, "COM_DLC_Checker     |   Github.com/Krypto5863/COM3D2_DLC_Checker (The Kry Fork)");
            CONSOLE_COLOR(ConsoleColor.Cyan, "===========================================================================================");
        }
        ...
        static string GET_COM3D2_INSTALLPATH()
        {
            ...
            {
                CONSOLE_COLOR(ConsoleColor.Yellow, "Warning : COM3D2 installation directory is not set in registry. Will work using directory', 'yellow'");
